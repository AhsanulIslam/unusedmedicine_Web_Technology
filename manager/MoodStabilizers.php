 ...
 <script>
          ...
          $(document).ready(function(){
                $('#search').on('keyup',function(){
                 $('#medicine').load('MoodStabilizersAjax.php',{searchval: document.getElementById('search').value });
             });
          });

          $(document).ready(function(){
                $('#medname').on('change',function(){
                 $('#medicine').load('MoodStabilizersAjax.php',{searchval1: document.getElementById('medname').value });
             });
          });

          $(document).ready(function(){
                $('#medbrand').on('change',function(){
                 $('#medicine').load('MoodStabilizersAjax.php',{searchval2: document.getElementById('medbrand').value });
             });
          });
...
<div class="medname"><h3>MoodStabilizers</h3></div>
