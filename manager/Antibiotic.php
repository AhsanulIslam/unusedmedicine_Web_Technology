...
// combination all
  ...
  // sort
     ...
     $MedQuery = "select * from medicine where category='Antibiotic' order by expdate ASC limit $startingRow, $perPage";
  }
 ...
 <script>
          ...
          $(document).ready(function(){
                $('#search').on('keyup',function(){
                 $('#medicine').load('AntibioticAjax.php',{searchval: document.getElementById('search').value });
             });
          });

          $(document).ready(function(){
                $('#medname').on('change',function(){
                 $('#medicine').load('AntibioticAjax.php',{searchval1: document.getElementById('medname').value });
             });
          });

          $(document).ready(function(){
                $('#medbrand').on('change',function(){
                 $('#medicine').load('AntibioticAjax.php',{searchval2: document.getElementById('medbrand').value });
             });
          });
...
<div class="medname"><h3>Antibiotic</h3></div>
