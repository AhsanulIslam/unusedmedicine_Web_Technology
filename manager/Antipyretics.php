...
// combination all
  ...
  // sort
     ...
     $MedQuery = "select * from medicine where category='Antipyretics' order by expdate ASC limit $startingRow, $perPage";
  }
 ...
 <script>
          ...
          $(document).ready(function(){
                $('#search').on('keyup',function(){
                 $('#medicine').load('AntipyreticsAjax.php',{searchval: document.getElementById('search').value });
             });
          });

          $(document).ready(function(){
                $('#medname').on('change',function(){
                 $('#medicine').load('AntipyreticsAjax.php',{searchval1: document.getElementById('medname').value });
             });
          });

          $(document).ready(function(){
                $('#medbrand').on('change',function(){
                 $('#medicine').load('AntipyreticsAjax.php',{searchval2: document.getElementById('medbrand').value });
             });
          });
...
<div class="medname"><h3>Antipyretics</h3></div>
