...
if (isset($_GET['edit']))
{
    ...
    $rec = mysqli_query($conn,"select * from donated_medicine where med_id = '".$med_id."'");
    ...
    $qu =  mysqli_query($conn,"select donated_medicine.location ,deliveryboy.DBoy_ID,deliveryboy.	DBoy_FNAME, deliveryboy.DBoy_ADDRESS from donated_medicine,deliveryboy where donated_medicine.med_id = '".$med_id."' and donated_medicine.location like deliveryboy.DBoy_ADDRESS;");
...
$loca  =$_POST['location'];
       ...
       $sql = "INSERT INTO donnersentdelivery (	type,med_name,ExpDate, batchid, brand,category,quantity,location,DBoy_ID) VALUES ('Donner','".$medname."','".$expdate."', '".$batchid2."', '".$brand1."', '".$cat."', '".$quan."', '".$loca."', '".$dboy_id."')";
       mysqli_query($conn, $sql);

       $s = "delete from donated_medicine where med_id = '$med_id'";
       mysqli_query($conn, $s);
       header('location: deliveryDonner.php');
}
...
<form action="deliveryDonner.php" method="post" onsubmit="return checkforblank()" name="frm">
...
<div class="refresh" id ="two"> <a href="instore.php"> <input type="submit" value="Status"></a> </div>

 <!-- <div class="refresh" id ="two">  <input type="submit" name="refresh1" value="Refesh"> </div> -->
      <!-- </div> -->
...
<div class="custom_select">
 <form action="deliveryDonner.php" method="get">
      <fieldset>
...
<div>
 ...
 <div class="displayData">
              <table>
                    ...
                    <?php while($row = $results->fetch_assoc()):  ?>
                            ...
                            <td>  
                          <a href="deliveryDonner.php?edit= <?php echo $row['med_id']; ?>" class="edit_btn">Assign</a> 
 ...
 <footer class="btn_next_pre">
          ...
          <a class="btnpg" href="deliveryDonner.php?x=<?php echo $a-1; ?>" >Previous</a>
          <?php endif; ?>

    <?php
      for($i=1; $i<=$np; $i++){ ?>
        <a class="btnpg" href="deliveryDonner.php?x=<?php echo $i; ?>"><?php echo $i; ?></a>
    <?php
      }
    ?>
  <?php if (($perPage+$startingRow) <= ($totalc-1)): ?>
    <a class="btnpg" href="deliveryDonner.php?x=<?php echo $a+1; ?>" >Next</a>
    <?php endif; ?>  
