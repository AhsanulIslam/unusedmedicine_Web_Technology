...
<div class="custom_select">
 <form action="reqlist.php" method="get">
      <fieldset>
...
<div>
 ...
 <div class="btn_next_pre">
  ...
  <?php if ($startingRow>0): ?>
        <a class="btnpg" href="reqlist.php?x=<?php echo $a-1; ?>" >Previous</a>
        <?php endif; ?>
    <?php
      for($i=1; $i<=$np; $i++){ ?>
        <a class="btnpg" href="reqlist.php?x=<?php echo $i; ?>"><?php echo $i; ?></a>
    <?php
      }
    ?>
  <?php if (($perPage+$startingRow) <= ($totalc-1)): ?>
    <a class="btnpg" href="reqlist.php?x=<?php echo $a+1; ?>" >Next</a>
    <?php endif; ?>  
