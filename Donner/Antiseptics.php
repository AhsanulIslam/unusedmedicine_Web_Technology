...
// combination all
  ...
  // sort
     ...
     $MedQuery = "select * from medicine where category='Antiseptics' order by expdate DESC limit $startingRow, $perPage";
  }
...
<form action="Antiseptics.php" method="post" onsubmit="return checkforblank()" name="frm">
...
<div class="refresh" id ="two"> <a href="Antiseptics.php"> <input type="submit" value="Refesh"></a> </div>
 ...
 <div class="displayData">
              <table>
                    ...
                    <?php while($row = $results->fetch_assoc()):  ?>
                            ...
                            <td>  
                          <a href="Antiseptics.php?edit= <?php echo $row['med_id']; ?>" class="edit_btn">Add</a> 
