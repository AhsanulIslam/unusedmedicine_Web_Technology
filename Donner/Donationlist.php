...
// $sqlshow = "select * from donated_medicine order by med_id DESC LIMIT $startingRow, $perPage ;";
...
<div class="custom_select">
 <form action="Donationlist.php" method="get">
      <fieldset>
...
<div class="btn_next_pre">
          ...
          <a class="btnpg" href="Donationlist.php?x=<?php echo ($a-1); ?>" >Previous</a>
          <?php endif; ?>
    ...
    <?php
      for($i=1; $i<=$np; $i++){ ?>
        <a class="btnpg" href="Donationlist.php?x=<?php echo $i; ?>"><?php echo $i; ?></a>
    <?php
      }
    ?>
  <?php if (($perPage+$startingRow) <= ($totalc-1)): ?>
    <a class="btnpg" href="Donationlist.php?x=<?php echo ($a+1); ?>" >Next</a>
    <?php endif; ?>  
